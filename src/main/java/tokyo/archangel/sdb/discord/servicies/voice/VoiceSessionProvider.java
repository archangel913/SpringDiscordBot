...
public class VoiceSessionProvider {
	 ...
	 * @return UDPコネクション
	 */
	public UdpConnection getUdpConnection(String websocketGuid, String address, int port) throws IllegalStateException {
	...
	public void removeServicies(String websocketGuid) throws IllegalStateException {
		...
		log.debug("Daveサービスを削除しました。現在有効なサービスは" + voiceSessionServices.size() + "個です");
	}
}
